...
with open('tRNA_11_culledfileout/'+fileout+suffix[0], 'w') as fo:
    fo.write('\n'.join(lines1))
with open('tRNA_11_culledfileout/'+fileout+suffix[1], 'w') as fo:
   fo.write('\n'.join(lines2))
with open('tRNA_11_culledfileout/'+fileout+suffix[2], 'w') as fo:
   fo.write('\n'.join(lines3))
