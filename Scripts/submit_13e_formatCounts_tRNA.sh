...
for f in $(ls tRNA_13_tempcounts/*_maxeVal_FL.txt) # tRNA_13_tempcounts/Olg_25_maxeVal_FL.txt
do
	g=$(basename $f|cut -f1 -d ".") # Olg_25_maxeVal_FL
...
for f in $(ls tRNA_13_tempcounts/*maxeVal_all.txt) # tRNA_13_tempcounts/Olg_25_maxeVal_all.txt
do
	g=$(basename $f|cut -f1 -d ".") # Olg_25_maxeVal_all
